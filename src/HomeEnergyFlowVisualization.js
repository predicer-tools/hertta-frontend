...
function HomeEnergyFlowVisualization({
  ...
  const getCurrentElectricityPrice = useCallback(() => {
    // Assuming electricityPrices is no longer used, you might want to fetch current price from an API
    // For demonstration, we'll return a static value or integrate another API
    return "0.25"; // Example static price
  }, []);
  ...
  const renderVisualization = useCallback(() => {
    ...
    svg
      ...
      .attr("fill", tempColor) // Dynamic color based on temperature
      .attr(
        "aria-label",
        ...
        <Popup onClose={() => setIsPopupOpen(false)}>
          <div className="popup-content">
            ...
            <table className="control-signals-table">
              ...
              <tbody>
                {/* Replace with actual electricity price data if available */}
                <tr>
                  <td>08:00</td>
                  <td>0.20</td>
                </tr>
